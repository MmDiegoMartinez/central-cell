...
<head>
    ...
    <style>
        ...
        .foto-btn {
            ...
            cursor: pointer; font-size: .95em; margin-bottom: 6px;
        }
    ...
    <script>
            ...
            if (/iPhone/.test(ua)) {
                ...
                if (!modelo) {
                    ...
                    if (m) {
                        ...
                        const marcas=[[/motorola|moto[\s_-]/i,'Motorola'],[/samsung|sm-|sch-/i,'Samsung'],
                            [/xiaomi|redmi|poco/i,'Xiaomi'],[/huawei/i,'Huawei'],[/oneplus/i,'OnePlus'],
                            [/oppo/i,'OPPO'],[/vivo/i,'Vivo'],[/realme/i,'Realme'],[/nokia/i,'Nokia'],[/asus/i,'ASUS']];
        ...
        function cambiarDpto() {
            ...
            document.getElementById('bloque-im').style.display = esTM ? 'none' : 'block';
            document.getElementById('bloque-tm').style.display = esTM ? 'block' : 'none';
            ...
            document.getElementById('numero_serie').required = esTM
                ? (document.getElementById('tipo_tm').value !== 'Smartwatch')
                : false;
        ...
        $(function() {
            ...
            $("#apasionado").autocomplete({
                source: function(req,res){ $.ajax({url:"../vendedor/buscar_colaborador.php",dataType:"json",data:{term:req.term},success:function(d){res(d);},error:function(){res([]);}}); },
                ...
                select:function(e,ui){e.preventDefault();$("#apasionado").val(ui.item.label);$("#apasionado_id").val(ui.item.value);$("#preview-apasionado").text("Seleccionado: "+ui.item.label);},
            ...
            $("#apasionado_tm").autocomplete({
                ...
                select:function(e,ui){e.preventDefault();$("#apasionado_tm").val(ui.item.label);$("#apasionado_id").val(ui.item.value);$("#preview-apasionado-tm").text("Seleccionado: "+ui.item.label);},
                open:function(){$(this).autocomplete("widget").find("li:first .ui-menu-item-wrapper").addClass("ui-state-active");}
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                const esTM = document.getElementById('toggle-dpto').checked;
                const campoAp = esTM
                    ? document.getElementById('apasionado_tm')
                    : document.getElementById('apasionado');
                ...
                reader.onload = async function(e) {
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            if (data.error && (data.error.message.toLowerCase().includes('storage') || data.status_code === 400)) {
                                estado.textContent = '❌ Sin espacio disponible. Comunícate con el administrador.';
                            } else {
                                estado.textContent = '❌ Error al subir la foto: '+(data.error?.message||'Error desconocido');
                            }
    ...
    <div class="contenedor">
        <div class="formulario">
            ...
            <form method="POST">
                ...
                <input type="hidden" id="dpto_input"  name="dpto" value="im">
                ...
                <div id="bloque-im" style="display:block">
                    ...
                    <select name="tipo_im" id="tipo_im" required>
                    ...
                    <select name="causa_im" id="causa_im" required>
                        <option value="">Seleccione</option>
                    ...
                    <input type="number" name="piezas_im" id="piezas_im" min="1" required><br><br>

                    <?php $sucursales = obtenerSucursalesValidador(); ?>
                    <label for="sucursal_im">Sucursal:</label>
                    <select name="sucursal_im" id="sucursal_im" required>
                    ...
                    <input type="date" name="fecha_im" id="fecha_im" value="<?= date('Y-m-d') ?>" required><br><br>

                    <label>Anotaciones (opcional):</label><br>
                    <textarea name="anotaciones_im" rows="4" cols="50" maxlength="2000"></textarea><br><br>
                ...
                <div id="bloque-tm" style="display:none">
                    ...
                    <input type="text" name="numero_serie" id="numero_serie"
                           maxlength="100" placeholder="IMEI, ICC, SN según aplique"><br><br>
                    ...
                    <textarea name="anotaciones_tm" id="anotaciones_tm" rows="4" cols="50" maxlength="2000"
                              placeholder="Describe la falla. Especifica si fue al contado o Pay Joy."></textarea><br><br>
                </div>
